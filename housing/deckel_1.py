...
seitenwand_hoehe = 10
seitenwand_dicke = wandstaerke
wand_z = gehause_hoehe + deckel_hoehe

# Linke lange Seite
linke_wand = Part.makeBox(
    seitenwand_dicke, gehause_breite, seitenwand_hoehe,
    Vector(0, 0, wand_z)
)

# Rechte lange Seite
rechte_wand = Part.makeBox(
    seitenwand_dicke, gehause_breite, seitenwand_hoehe,
    Vector(gehause_laenge - seitenwand_dicke, 0, wand_z)
)

# Untere kurze Seite (Vorderseite)
vorderwand = Part.makeBox(
    gehause_laenge - 2 * seitenwand_dicke, seitenwand_dicke, seitenwand_hoehe,
    Vector(seitenwand_dicke, 0, wand_z)
)

# Wände zum Deckel hinzufügen
deckel = deckel.fuse(linke_wand)
deckel = deckel.fuse(rechte_wand)
deckel = deckel.fuse(vorderwand)
